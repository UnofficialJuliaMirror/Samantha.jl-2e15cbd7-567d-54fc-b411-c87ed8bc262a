...
function BrainModel(config::Dict)
  ...
  numCol = Base.get!(_config, "numCol", 4)
  numTR = Base.get!(_config, "numTR", numCol)
  szTR = Base.get!(_config, "szTR", 64)
  sztRN = Base.get!(_config, "sztRN", 32)
  szL23e = Base.get!(_config, "szL23e", 32)
  szL4e = Base.get!(_config, "szL4e", 32)
  szL5e = Base.get!(_config, "szL5e", 32)
  szL6e = Base.get!(_config, "szL6e", 32)

  numLanes = Base.get!(_config, "numLanes", 4)
  szUS = Base.get!(_config, "szUS", 8)
  szCS = Base.get!(_config, "szCS", 8)
  szDA = Base.get!(_config, "szDA", 8)
  szPV = Base.get!(_config, "szPV", 8)
  szLV = Base.get!(_config, "szLV", 8)

  numZones = Base.get!(_config, "numZones", 4)
  szGr = Base.get!(_config, "szGr", 32)
  szPk = Base.get!(_config, "szPk", 8)
  szDc = Base.get!(_config, "szDc", 4)
  szIo = Base.get!(_config, "szIo", 4)
